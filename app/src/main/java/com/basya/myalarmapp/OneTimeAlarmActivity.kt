package com.basya.myalarmapp

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import com.basya.myalarmapp.databinding.ActivityMainBinding
import com.basya.myalarmapp.fragment.DatePickerFragment
import com.basya.myalarmapp.fragment.TimePickerFragment
import com.basya.myalarmapp.room.Alarm
import com.basya.myalarmapp.room.AlarmDB
...
class OneTimeAlarmActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener,
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_set_time_one_time -> {
                ...
                timePickerFragmentOnTime.show(supportFragmentManager, TIME_PICKER_ONCE_TAG)
            }
